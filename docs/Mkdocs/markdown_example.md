...
```
<a href="../sources/videos/big_buck_bunny.mp4" >big_buck_bunny.mp4</a>
...
```
[big_buck_bunny.mp4](../sources/videos/big_buck_bunny.mp4)
...
```
![picture](../sources/images/ball1.gif){: style="height:100px;width:100px"}
```
...
```
<img src="../sources/svgs/ubuntu.svg" width="30" height="30">
```
...
[Go Back MKDocs](./README.md){ .md-button .md-button--primary }
